    ...
    public partial class View_Plan_StockListDAL
    {
        ...
        public WMS_Database.View_Plan_StockListModel DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["Plan_List_Quantity"] != null)
                {
                    model.Plan_List_Quantity = row["Plan_List_Quantity"].ToString();
                }
                if (row["Plan_List_Ordered_Quantity"] != null)
                {
                ...
                if (row["Plan_List_Finished_Quantity"] != null)
                {
